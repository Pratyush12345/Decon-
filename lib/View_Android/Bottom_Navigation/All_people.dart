...
class _AllPeople extends State<AllPeople> {
  ...
  _initialize() async{
    ...
    print("selected admin==========${widget.clientDetailModel?.selectedAdmin}");
    
    await AllPeopleVM.instance.getManagerDetail(widget.clientDetailModel?.selectedManager);
    print(AllPeopleVM.instance.managerDetailModel);
    print(AllPeopleVM.instance.managerDetailModel?.key);
